    ...
    SubShader{
        ...
        Pass{
            ...
            half4 frag(Varyings IN) : SV_Target{
                ...
                float4 effect = texCUBE(_GlobalEffectRTCubeMap, IN.normal);
                ...
                float3 path = lerp(_PathColorOut.rgb * effect.r, _PathColorIn.rgb, saturate(effect.r * _PathBlending));
                float3 mainColors = lerp(snowTex,path, saturate(effect.r));
                ...
                litMainColors += cutoffSparkles  * saturate(1- (effect.r * 2)) * 4;
